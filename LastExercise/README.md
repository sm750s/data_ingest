...
```
```
[centos@m1 ~]$ service nscd status
Redirecting to /bin/systemctl status nscd.service
Unit nscd.service could not be found.
[centos@m1 ~]$ sudo yum install nscd
[centos@m1 ~]$ sudo systemctl start nscd
[centos@m1 ~]$ sudo systemctl status nscd
[centos@m1 ~]$ sudo systemctl enable nscd
```
![Image of System Configuration 012-001](screenshots/system-config-012-001.png)
